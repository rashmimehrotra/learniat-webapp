							...
							if ($status_id == "1" or $status_id == "5" or $status_id == "6")
								...
								if($status_id == 5)
								{
									...
									while ($stud_f=mysql_fetch_array($stud_q))
									{
										...
										$sel_max="select max(gi_class_den),attendance_id from stud_session_time inner join class_sessions on class_sessions.class_session_id=stud_session_time.class_session_id where student_id='$stud_v' and class_id='$class_id'";
