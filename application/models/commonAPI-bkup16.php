									...
									else if (!strcasecmp($student_id, 'Agg_Lev=0'))
									{
										...
										if($index_type==1)
										{
											...
											while ($stud_f=mysql_fetch_array($stud_q))
											{
												...
												$arr[SMC::$STUDENTS][SMC::$STUDENT][$i][SMC::$STUDENTID]=$stud_v;
												$arr[SMC::$STUDENTS][SMC::$STUDENT][$i][SMC::$GRASPINDEX]=$index_v;
												$i++;
											}
										}
										else if($index_type==2)
										{
											...
											while ($stud_f=mysql_fetch_array($stud_q))
											{
												...
												$index_v=$pi;
												$arr[SMC::$STUDENTS][SMC::$STUDENT][$i][SMC::$STUDENTID]=$stud_v;
												$arr[SMC::$STUDENTS][SMC::$STUDENT][$i][SMC::$PARTICIPATIONINDEX]=$index_v;
												$i++;
											}
										}
									}
									...
									if(strcasecmp($student_id, 'Agg_Lev=0') && strcasecmp($student_id, 'Agg_Lev=1'))
									{
										...
										if($index_type==1)
										{
											...
											while ($topic_f=mysql_fetch_array($topic_q))
											{
												...
												$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$TOPICID]=$topic_v;
												$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$GRASPINDEX]=$index_v;
												$i++;
											}
										}
										else if($index_type==2)
										{
											...
											while ($topic_f=mysql_fetch_array($topic_q))
											{
												...
												$index_v=$pi;
												$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$TOPICID]=$topic_v;
												$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$PARTICIPATIONINDEX]=$index_v;
												$i++;
											}
										}
									}
										...
										if($index_type==1)
										{
											...
											while ($topic_f=mysql_fetch_assoc($topic_q))
											{
												...
												while ($stud_f=mysql_fetch_array($stud_q))
												{
													...
													$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$TOPICID]=$topic_v;
													$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$STUDENTID]=$stud_v;
													$arr[SMC::$TOPICS][SMC::$TOPIC][$i][SMC::$GRASPINDEX]=$index_v;
													$i++;
												}
											}
									...
									if(strcasecmp($student_id, 'Agg_Lev=0') && strcasecmp($student_id, 'Agg_Lev=1'))
									{
										...
										if($index_type==1)
										{
											...
											while ($sess_f=mysql_fetch_assoc($sess_q))
											{
												...
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$SESSIONID]=$sess_v;
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$CLASSID]=$class_v;
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$GRASPINDEX]=$index_v;
												$i++;
											}
										}
										else if($index_type==2)
										{
											...
											while ($sess_f=mysql_fetch_assoc($sess_q))
											{
												...
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$SESSIONID]=$sess_v;
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$CLASSID]=$class_v;
												$arr[SMC::$SESSIONS][SMC::$SESSION][$i][SMC::$PARTICIPATIONINDEX]=$index_v;
												$i++;
											}
										}
									}
