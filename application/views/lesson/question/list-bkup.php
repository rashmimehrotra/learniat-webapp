...
<?php else : ?>
    ...
    <?php
    foreach ($questionDetails AS $key => $details) :
        $graphFlag = (($details->averageScoreOfClass == 0 && $details->classAverageDataRows == 0) ? false : true);
        ?>
        <div class="topic-bar-box-question sess-expand-box" id="questionList-<?php echo $details->question_id; ?>">
            ...
            <table width="98%" >
                <tr>
                    ...
                    <?php endif; ?>
                    <td class="<?php echo (($graphFlag) ? 'responseTdMin': 'responseTdMax'); ?>">
