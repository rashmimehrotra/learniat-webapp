<link rel="stylesheet" href="<?php echo base_url('assets/imagecropt_test/css/font-awesome.min.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/imagecropt_test/css/bootstrap.min.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/imagecropt_test/css/tooltip.min.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/imagecropt_test/dist/cropper.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/imagecropt_test/css/main.css'); ?>">
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="img-container">
                <img src="<?php echo base_url('assets/imagecropt_test/img/picture.jpg'); ?>" alt="Picture">
            </div>
        </div>
        <div class="col-md-3">
...
<!-- Scripts -->
<script src="<?php echo base_url('assets/imagecropt_test/js/jquery.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/imagecropt_test/js/tooltip.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/imagecropt_test/js/bootstrap.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/imagecropt_test/dist/cropper.js'); ?>"></script>
<!--<script src="<?php echo base_url('assets/imagecropt_test/js/main.js'); ?>"></script>-->
<script>
