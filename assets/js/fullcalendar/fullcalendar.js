...
var TimeGrid = Grid.extend({
	...
	slatRowHtml: function() {
		...
		while (slotTime < this.maxTime) {
			...
			axisHtml =
                (isLabeled ? 
				'<td class="fc-axis fc-time ' + view.widgetContentClass + '" style="width:' + (parseInt(this.axisWidth) * 2) + 'px;vertical-align:middle;" rowspan="2">' +
					(isLabeled ?
						'<span style="vertical-align:middle;">' + // for matchCellWidths
