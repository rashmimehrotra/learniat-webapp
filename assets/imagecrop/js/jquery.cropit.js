	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function getCroppedImageData(exportOptions) {
	      ...
	      if (exportOptions.type === 'image/jpeg') {
			...
			console.log(this.rotatedOffset.x * exportZoom + ' ' + this.rotatedOffset.y * exportZoom);
			canvasContext.fillStyle = exportOptions.fillBg;
			canvasContext.fillRect(0, 0, canvas.width,this.rotatedOffset.y * exportZoom);
			canvasContext.fillRect(0, 0, this.rotatedOffset.x * exportZoom,canvas.height);
			canvasContext.fillRect((this.rotatedOffset.x * exportZoom)+zoomedSize.width, 0, canvas.width-((this.rotatedOffset.x * exportZoom)+zoomedSize.width),canvas.height);
			canvasContext.fillRect(0,(this.rotatedOffset.y * exportZoom)+zoomedSize.height,canvas.width, canvas.height-((this.rotatedOffset.y * exportZoom)+zoomedSize.height));
